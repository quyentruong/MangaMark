<template>
  <div>
    <div v-if="len === 0" class="text-center">
      An email verification has sent to your account. You need to verify it
      before login.
    </div>
    <template v-else>
      <v-row
      ...
      <template v-else-if="verify">
        <div class="text-center">Verify Completed. You can login now.</div>
